...
fig = plt.figure('init_detuning_4s', figsize = (10,6))

# Plot and label spectrogram
ax1 = fig.add_subplot(2,1,1)
# ax1.plot_stft(stft, t, f, range=spectrogram_lims, png=None)
ax1.set_title('Effect of initial detuning, $\Delta_i = 4$ kHz')
...
# Save figures
plt.savefig(os.path.join(folder, 'init_detuning_4s.png'), dpi = 300, bbox_inches='tight')
plt.savefig(os.path.join(folder, 'init_detuning_4s.pdf'), dpi = 300, bbox_inches='tight')
