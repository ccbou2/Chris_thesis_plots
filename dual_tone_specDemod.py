...
fig = plt.figure('dual_tone_specDemod', figsize = (10,6))

# Plot and label spectrogram
ax1 = fig.add_subplot(2,1,1)
# ax1.plot_stft(stft, t, f, range=spectrogram_lims, png=None)
ax1.set_title('Dual-tone signal response')
...
# Save figures
plt.savefig(os.path.join(folder, 'dual_tone_specDemod2.png'), dpi = 300, bbox_inches='tight')
plt.savefig(os.path.join(folder, 'dual_tone_specDemod2.pdf'), dpi = 300, bbox_inches='tight')
