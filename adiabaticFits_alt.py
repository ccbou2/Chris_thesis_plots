...
fig = plt.figure('adiabaticFits', figsize = (10,6))

# Plot and label spectrogram
ax1 = fig.add_subplot(2,1,1)
# ax1.plot_stft(stft, t, f, range=spectrogram_lims, png=None)
ax1.set_title('Fitting for an adiabatic transition')
...
# Save figures
plt.savefig(os.path.join(folder, 'adiabaticFits_alt2.png'), dpi = 300, bbox_inches='tight')
plt.savefig(os.path.join(folder, 'adiabaticFits_alt2.pdf'), dpi = 300, bbox_inches='tight')
print('Plotting complete, outputs saved to ' + str(folder))

# Define figure object
fig = plt.figure('adiabaticFits2', figsize = (10,6))
...
# ax2.text(0.21, -0.4, result_string_an, c = 'k')
# ax2.text(0.21, -0.7, result_string_exp, c = 'g')
ax2.text(textCoords_x(0.042), textCoords_y(0.411), 'fit results:', c = colours[0])
ax2.text(textCoords_x(0.042), textCoords_y(0.245), result_string_ad, c = colours[1])
# ax2.text(textCoords_x(0.042), textCoords_y(0.245), result_string_an, c = 'k')
ax2.text(textCoords_x(0.042), textCoords_y(0.088), result_string_exp, c = 'g')
# textObjs = [t1,t2,t3]
...
# ax2.add_patch(patches.Rectangle((0.208, -0.50), 0.023, 0.9, facecolor = 'white', edgecolor = 'k', alpha = 0.5))
# ax2.add_patch(patches.Rectangle((0.208, -0.75), 0.023, 1.15, facecolor = 'white', edgecolor = 'k', alpha = 0.5))
ax2.add_patch(patches.Rectangle((textCoords_x(0.03), textCoords_y(0.0588)), 0.205*trange, 0.42*Qrange, facecolor = 'lightgrey', edgecolor = 'k', alpha = 0.5))

plt.show()

# Save figures
plt.savefig(os.path.join(folder, 'adiabaticFits_alt.png'), dpi = 300, bbox_inches='tight')
plt.savefig(os.path.join(folder, 'adiabaticFits_alt.pdf'), dpi = 300, bbox_inches='tight')
print('Plotting complete, outputs saved to ' + str(folder))