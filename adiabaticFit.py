...
ax2.add_patch(patches.Rectangle((textCoords_x(0.03), textCoords_y(0.0588)), 0.22*trange, 0.62*Qrange, facecolor = 'lightgrey', edgecolor = 'k', alpha = 0.5))

# Save figures
plt.savefig(os.path.join(folder, 'adiabaticFits2.png'), dpi = 300, bbox_inches='tight')
plt.savefig(os.path.join(folder, 'adiabaticFits2.pdf'), dpi = 300, bbox_inches='tight')
...
# Save figures
plt.savefig(os.path.join(folder, 'adiabaticFits.png'), dpi = 300, bbox_inches='tight')
plt.savefig(os.path.join(folder, 'adiabaticFits.pdf'), dpi = 300, bbox_inches='tight')
print('Plotting complete, outputs saved to ' + str(folder))